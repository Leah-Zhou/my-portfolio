  ...
  return (
    ...
    <div className="hero-wrap">
     ...
     <section className="project-title">
       ...
       <a  href="https://www.figma.com/file/MkVES2EMflZklGXz9vXp8G/SunnyOp-website?node-id=0%3A1" target="_blank" className="btn-link animate-btn"><span>Play Prototype</span></a>
     </section>
    </div>
